...
namespace RaspberrySharp.Components.Clocks
{
    /// <summary>
    ///     Provides functionality for the DS1307 Real-Time Clock.
    /// </summary>
    public class Ds1307_I2C
    {
        /// <summary>
        ...
        public Ds1307_I2C(I2cDeviceConnection connection)
        {
        ...
        /// <summary>
        ///     Reads the Date and Time from the Ds1307_I2C and returns it.
        /// </summary>
        ...
        /// <summary>
        ///     Writes the provided Date and Time to the Ds1307_I2C.
        /// </summary>
        ...
        private DateTime GetDate(byte[] input)
        {
            ...
            if ((hours & 64) == 64) throw new NotImplementedException("AM/PM Time is currently not supported.");
