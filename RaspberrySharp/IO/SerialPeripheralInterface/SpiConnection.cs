using RaspberrySharp.IO.SerialPeripheralInterface.EnumTypes;
using RaspberrySharp.System.Timers;
using System;

namespace RaspberrySharp.IO.SerialPeripheralInterface
{
    /// <summary>
    ...
    public class SpiConnection : IDisposable
    {
        ...
        public ulong Read(int bitCount)
        {
            ...
            {
                var index = endianness == Endianness.LittleEndian
                                ? i
                                : bitCount - 1 - i;
